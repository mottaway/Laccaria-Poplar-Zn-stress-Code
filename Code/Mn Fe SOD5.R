...
MNFESOD5D14 = readxl::read_excel("PaperJSMOKV.xlsx", sheet = 15) 
head(MNFESOD5D14)

MNFESOD5D14$Tissue = as.factor(MNFESOD5D14$Tissue)
MNFESOD5D14$Zn <- factor(MNFESOD5D14$Zn, levels=c("Control", "1.5 mM Zn"))
MNFESOD5D14$`MNFESOD5D14log2` = as.numeric(MNFESOD5D14$`MNFESOD5D14log2`)
MNFESOD5D14$`MNFESOD5D14Mean` = as.numeric(MNFESOD5D14$`MNFESOD5D14Mean`)
MNFESOD5D14$`MNFESOD5D14SE` = as.numeric(MNFESOD5D14$`MNFESOD5D14SE`)

Tissue <- MNFESOD5D14$Tissue
Zn <- MNFESOD5D14$Zn
log2 <- MNFESOD5D14$`MNFESOD5D14log2`
Mean<- MNFESOD5D14$`MNFESOD5D14Mean`
SE<- MNFESOD5D14$`MNFESOD5D14SE`
...
w <- summary(x)
w
capture.output(w ,file="MNFESOD5 D14 Anova Paper.doc") #store data
...
write.csv2(Statistics, file = "MNFESOD5 D14 Tukey paper.csv")
...
figure <-
ggplot(MNFESOD5D14, aes(x = Tissue, y = Mean, fill=Zn, color = Zn)) +
...
labs(title = "Mn/Fe SOD5", x= " ", y = "Log2 (Relative expression)") +
